---
date: 2026-06-10
context: CV Interactivo — búsqueda difusa en la sección de bitácora con un Web Component (`<logbook-search>`) embebido en Astro 6. La interactividad vive en un `<script>` procesado por Vite, sin añadir React ni `@astrojs/react` al proyecto.
technologies:
  - Astro
  - TypeScript
  - Fuse.js
